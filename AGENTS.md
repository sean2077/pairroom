...
- Keep the root module on the latest stable Go release with the approved pinned CGo-free SQLite dependency closure. Dependency checks must reject replacements and version drift; GUI dependencies remain in the separate desktop module.
