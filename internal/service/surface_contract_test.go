...
func TestSurfaceParticipantControlsMatchRoomAPI(t *testing.T) {
	for _, test := range []struct {
		...
		{http.MethodPut, "/api/v1/participants/slot1/permissions", true},
		{http.MethodPut, "/api/v1/participants/slot2/permissions", true},
		{http.MethodPost, "/api/v1/participants/slot1/permissions", false},
		{http.MethodGet, "/api/v1/participants/slot1/permissions", false},
		{http.MethodPut, "/api/v1/participants/slot2/role", false},
		{http.MethodPost, "/api/v1/participants/slot2/role", false},
		{http.MethodPost, "/api/v1/participants/slot2/start", true},
		{http.MethodPost, "/api/v1/participants/slot2/stop", true},
		{http.MethodPost, "/api/v1/participants/slot2/restart", true},
		{http.MethodPost, "/api/v1/participants/slot2/interrupt", true},
		{http.MethodPost, "/api/v1/participants/slot2/START", true},
		{http.MethodPut, "/api/v1/participants/slot2/start", false},
		{http.MethodPost, "/api/v1/participants/slot2/unknown", false},
		{http.MethodPost, "/api/v1/participants/slot2/nested/start", false},
